...
# Estimate a regression model.
lm_model_4 <- lm(data = life_exp_data,
                 formula = lifeexpect ~ 
                   medinc + uninsured +
                   smoke + obesity + teenbirth + 
                   # gunlaw + 
...
##################################################
# Models with 2 variables removed
##################################################

# Estimate a regression model.
lm_model_5 <- lm(data = life_exp_data,
                 # Remove some variables from here:
                 formula = lifeexpect ~
                   # medinc + 
                   # uninsured +
...
# Estimate a regression model.
lm_model_6 <- lm(data = life_exp_data,
                 # Remove some variables from here:
                 formula = lifeexpect ~
                   # medinc + 
                   uninsured +
...
# Estimate a regression model.
lm_model_X <- lm(data = life_exp_data,
                 # Remove some variables from here:
                 formula = lifeexpect ~
                   # medinc 
                   # + uninsured 
